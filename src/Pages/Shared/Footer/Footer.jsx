...
const Footer = () => {
        return (
          <footer className="bg-[#000D30] text-[#CCCCCC] py-8 px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className=''>
                  ...
                  <ul className="space-y-2 text-[10px] md:[20px]">
                    ...
                    <li><a href="#" className="hover:text-blue-600 transition duration-200">Portfolio</a></li>
                    <li><a href="#" className="hover:text-blue-600 transition duration-200">Blogs</a></li>
                    <li><a href="#" className="hover:text-blue-600 transition duration-200">Contact Us</a></li>
                  </ul>
                </div>
                </div>
    
                {/* Empty column for spacing (can add more content if needed) */}
                <div>
